    ...
    public class Aluno : AcessoDados
    {
        ...
        public void Cadastrar()
        {
            try
            {
                ...
                new SqlParameter("dtNasci", DtNascimento),
        ...
        public string Atualizar()
        {
            try
            {
                //indicar o nome de uma procedure 
                string nomeProcedure = "SP_AtualizaAluno";
                //Alimentar os parametros da procedure 
                List<SqlParameter> parametros = new List<SqlParameter>
                {
                    new SqlParameter("Nome", Nome),
        ...
        public List<Aluno> ObterAlunos()
        {
            try
            {
               ...
               List<Aluno> alunos = new List<Aluno>();
                ...
                {
                    throw new Exception("Não houve retorno do banco de dados.");
                }
            }
            catch (Exception)
            {
